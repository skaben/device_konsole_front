<template>
  <div class="interface">
    <div class="interface_header" data-element="header">
      <p> TRIES LEFT: <span data-element="tries"></span></p>
      <p data-element="status"></p>
    </div>
    <div class="interface_content">
      <div class="hack-content">{{ content.left }}</div>
      <div class="hack-content">${{ content.right }}</div>
...
<script>
import socket from "../../../app/src/util/socket";
import {
  chunkArrayInGroups,
  getRandomFromArray,
  getRandomInt,
